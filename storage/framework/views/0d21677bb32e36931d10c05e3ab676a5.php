...
<body>
    ...
    <div class="container">
        ...
        <div class="jurusan-container">
            ...
            <!-- RPL -->
            <div class="card">
                <img src="<?php echo e(asset('images/rpl.jpg')); ?>" alt="RPL">
            ...
            <!-- TKR -->
            <div class="card">
                <img src="<?php echo e(asset('images/tkr.jpg')); ?>" alt="TKR">
            ...
            <!-- BD -->
            <div class="card">
                <img src="<?php echo e(asset('images/bd.jpg')); ?>" alt="BD">
            ...
            <!-- APHP -->
            <div class="card">
                <img src="<?php echo e(asset('images/aphp.jpg')); ?>" alt="APHP">
...
<?php /**PATH E:\web-sekolah-sri\resources\views/jurusan.blade.php ENDPATH**/ ?>