...
<body>
    ...
    <div class="container">
        ...
        <div class="eskul-container">
            ...
            <!-- PRAMUKA -->
            <div class="card">
                <img src="{{ asset('images/pramuka.jpg') }}" alt="Pramuka">
            ...
            <!-- PASKIBRA -->
            <div class="card">
                <img src="{{ asset('images/paskibra.jpg') }}" alt="Paskibra">
            ...
            <!-- CINEMAK -->
            <div class="card">
                <img src="{{ asset('images/cinemak.jpg') }}" alt="Cinemak">
            ...
            <!-- PMR -->
            <div class="card">
                <img src="{{ asset('images/pmr.jpg') }}" alt="PMR">
            ...
            <!-- MEARCHING BAND -->
            <div class="card">
                <img src="{{ asset('images/mearching-band.jpg') }}" alt="Mearching Band">
            ...
            <!-- VOLI -->
            <div class="card">
                <img src="{{ asset('images/voli.jpg') }}" alt="Voli">
            ...
            <!-- BAHASA JEPANG -->
            <div class="card">
                <img src="{{ asset('images/bahasa-jepang.jpg') }}" alt="Bahasa Jepang">
            ...
            <!-- ROHIS -->
            <div class="card">
                <img src="{{ asset('images/rohis.jpg') }}" alt="Rohis">
